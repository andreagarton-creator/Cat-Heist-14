...
window.DockScene=class extends MultiScene{constructor(){super('Dock')}preload(){this.load.image('dock','assets/dock.jpg')}create(){this.add.image(960,540,'dock');const p=[G.platform(this,307,948,614,55),G.platform(this,275,535,462,50),G.platform(this,728,310,198,45),G.platform(this,650,370,48,160),G.platform(this,1082,448,252,50),G.platform(this,838,810,280,52),G.platform(this,975,730,52,220),G.platform(this,1325,780,340,55),G.platform(this,1172,925,90,310),G.platform(this,1452,925,90,310),G.platform(this,1585,300,500,55)];this.setupPlayer({x:125,y:835},p);this.basket=G.zone(this,1475,235,150,90);this.physics.add.overlap(this.cat.root,this.basket,async()=>{if(Session.local.hasFish||!Session.local.hasCostume)return;await Net.objective('fish');G.achievement(this,'GEM FISH ACQUIRED')});G.hud(this,'THE DOCK','Dock')}update(t){this.multiUpdate(t)}};
